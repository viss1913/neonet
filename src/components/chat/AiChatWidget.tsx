  ...
  return (
    <>
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            role="dialog"
            aria-label={site.chat.dialogAria.replace('{{name}}', site.chat.name)}
          >
            <header className="flex items-center gap-3 border-b border-black/5 bg-bg-light px-4 py-3">
              ...
              <button
                ...
                aria-label={site.chat.closeAria}
              >
                ✕
              </button>
            </header>
            ...
            <form onSubmit={onSubmit} className="border-t border-black/5 p-3">
              <div className="flex gap-2">
                <input
                  ...
                  placeholder={site.chat.inputPlaceholder.replace('{{name}}', site.chat.name)}
      ...
      <button
        ...
        aria-expanded={open}
        aria-label={site.chat.openAria.replace('{{fabLabel}}', site.chat.fabLabel)}
      >
