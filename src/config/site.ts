export const site = {
  ...
  chat: {
    title: 'Консультант ВЭД',
    greeting: 'Здравствуйте! Я консультант NeoNet по вопросам импорта, экспорта и инфраструктуры ВЭД. Чем помочь?',
    disclaimer: 'Ответы носят информационный характер и не являются юридической консультацией.',
    avatar: '/images/ai/ai-consultant-avatar.webp',
    quickReplies: [
