export const site = {
  ...
  chat: {
    name: 'Коля',
    title: 'Коля',
    subtitle: 'Робот-консультант NeoNet · ВЭД',
    typingLabel: 'Коля печатает',
    greeting:
      'Привет! Я Коля — робот-консультант NeoNet. Помогу с импортом, экспортом, логистикой и рисками ВЭД. Чем могу быть полезен?',
    disclaimer: 'Ответы носят информационный характер и не являются юридической консультацией.',
    /** Опционально: своё фото робота webp/png. Пусто = SVG kolya-robot.svg */
    avatarPhoto: '' as string,
    quickReplies: [
